...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-stone-900 border-t border-stone-200/90 dark:border-stone-800 py-6 pb-24 md:pb-6 text-center text-xs text-stone-500 dark:text-stone-400 transition-colors">
